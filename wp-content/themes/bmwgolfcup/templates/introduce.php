...
<main id="primary" class="site-content mt-[34px] pb-[45px] px-4">
  ...
  if (strlen($introduce_banner) > 0) {
    $introduce_banner_img_html = '<img src="' . $introduce_banner . '" class="mt-6 mb-4 object-cover h-[148px] w-full rounded-lg border border-white border-opacity-20" />';
  }
  ...
  <div class="mt-[24px]">
    ...
    if (strlen($introduce_tournament_process) > 0) {
      ...
      <a href="#"><img src="' . $introduce_tournament_process . '" class="mt-4 object-cover h-full w-full rounded-lg" /></a>
      ';
    }
